...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/CAviewsDistrbution.png} % 替换 example-image 为图片文件名
  ...
  \label{fig:views} % 标签用于引用
  \end{figure}
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figure/CAlikesDistrbution.png} % 替换 example-image 为图片文件名
    ...
    \label{fig:likes} % 标签用于引用
    \end{figure}
    \begin{figure}[H]
      \centering
      \includegraphics[width=0.6\textwidth]{figure/CAdislikesDistrbution.png} % 替换 example-image 为图片文件名
      ...
      \label{fig:dislikes} % 标签用于引用
      \end{figure}
      \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{figure/CAcomment_countDistrbution.png} % 替换 example-image 为图片文件名
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/CAtitleWordCloud.png} % 替换 example-image 为图片文件名
  \caption{The word cloud of titles in Canada.}
  \label{fig:title} % 标签用于引用
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/CAtagsWordCloud.png} % 替换 example-image 为图片文件名
  \caption{The word cloud of tags in Canada.}
  \label{fig:tag} % 标签用于引用
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{figure/CAdescriptionWordCloud.png} % 替换 example-image 为图片文件名
  \caption{The word cloud of descriptions in Canada.}
  \label{fig:description} % 标签用于引用
\end{figure}
\section{Method}
...
\begin{table}[ht]
  ...
  \caption{Performance Metrics of Eight Models}
  \label{tab:model_metrics}
 
  \begin{tabular}{lccc}
  \toprule
  \textbf{Model} & \textbf{MSE} & \textbf{MAE} & \textbf{R2} \\
  \midrule
